        ...
        <div className="hidden md:flex items-center space-x-1">
          {navItems.map((item) => (
            <a
              ...
              className="px-4 py-2 rounded-md text-[11px] uppercase tracking-[0.2em] text-gray-600 hover:text-white hover:bg-primary transition-all duration-300 font-serif font-bold"
            >
              {item.name}
            </a>
          ))}
        ...
        <div className="flex items-center space-x-6">
          ...
          <div className="relative group">
            ...
            <div className="absolute right-0 top-full mt-2 w-52 bg-white border border-gray-100 rounded-lg shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 p-2 border-t-4 border-t-primary">
              <button className="w-full text-left px-4 py-2.5 text-xs hover:bg-gray-50 text-gray-600 rounded-md transition-colors flex items-center font-serif uppercase tracking-widest font-bold">
                <User className="w-4 h-4 mr-3 text-accent" /> My Account
              </button>
              <a 
                href="#tickets"
                onClick={(e) => scrollToSection(e, '#tickets')}
                className="w-full text-left px-4 py-2.5 text-xs hover:bg-gray-50 text-gray-600 rounded-md transition-colors flex items-center font-serif uppercase tracking-widest font-bold"
              >
                <Ticket className="w-4 h-4 mr-3 text-accent" /> Submit Ticket
              </a>
              <div className="my-1 border-t border-gray-50"></div>
              <button className="w-full text-left px-4 py-2.5 text-xs hover:bg-red-50 text-red-500 rounded-md transition-colors flex items-center font-serif uppercase tracking-widest font-bold">
