    ...
    <div className="pt-10">
      <div className="flex flex-col items-center text-center mb-16">
        <div className="w-24 h-24 mb-6 border-2 border-accent/30 rounded-full p-2 flex items-center justify-center shadow-sm">
          <div className="w-full h-full bg-surface rounded-full flex items-center justify-center">
            <span className="font-sans text-3xl font-bold text-primary">SS</span>
          </div>
        </div>
        <h1 className="font-sans text-4xl md:text-5xl tracking-tight text-primary mb-4 font-bold">
      ...
      {!user.completedOnboarding && (
        <div className="bg-surface border border-gray-100 rounded-xl p-8 mb-16 flex flex-col md:flex-row items-center justify-between space-y-6 md:space-y-0 relative overflow-hidden group shadow-sm">
          ...
          <div>
            <h3 className="text-2xl font-sans text-primary mb-2 font-bold uppercase tracking-tight">Initiate Your Membership</h3>
      ...
      {user.completedOnboarding && (
        <div className="bg-primary/5 border border-primary/10 rounded-xl p-8 mb-16 text-center">
          <h3 className="text-xl font-sans text-primary mb-1 uppercase tracking-[0.2em] font-bold">Full Member Access Granted</h3>
