  ...
  return (
    <div className="space-y-16">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 border-b border-gray-100 pb-10">
        <div>
          <h2 className="text-3xl font-sans text-primary mb-2 font-bold uppercase tracking-tight">Archives & Intelligence</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
        ...
        <aside className="lg:col-span-1 space-y-10">
          <div className="space-y-4">
            <h4 className="text-[10px] uppercase tracking-[0.2em] text-gray-400 font-sans mb-4 flex items-center font-bold">
          ...
          <div className="bg-surface border border-gray-100 rounded-xl p-6 space-y-6">
            <h4 className="text-[10px] uppercase tracking-[0.2em] text-gray-400 font-sans font-bold">Verified Merits</h4>
